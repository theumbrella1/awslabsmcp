...
from awslabs.{{cookiecutter.project_domain | lower | replace(' ', '_') | replace('-', '_')}}_mcp_server.utils import indexer
...
class TestIndexer:
    ...
    def test_search_multiple_documents_ranking(self):
        ...
        doc1 = indexer.Doc(
            uri='url1',
            display_title='Documentation Guide',
            content='Basic content',
            index_title='Documentation Guide',
        )
        ...
        doc2 = indexer.Doc(
            ...
            content='This is about documentation development',
    ...
    def test_search_multi_token_query(self):
        ...
        doc1 = indexer.Doc(
            uri='url1',
            display_title='Documentation Core',
            content='documentation core functionality',
            index_title='Documentation Core',
        )
        doc2 = indexer.Doc(
            uri='url2',
            display_title='Documentation Guide',
            content='basic documentation tutorial',
            index_title='Documentation Guide',
        )
        doc3 = indexer.Doc(
            uri='url3',
        ...
        # Act
        results = index.search('documentation core')
    ...
    def test_search_case_insensitive(self):
        ...
        index = indexer.IndexSearch()
        doc = indexer.Doc(
            uri='url', display_title='Title', content='Documentation Development', index_title='Title'
        )
        index.add(doc)

        # Act
        results_lower = index.search('documentation')
        results_upper = index.search('DOCUMENTATION')
        results_mixed = index.search('Documentation')
    ...
    def test_title_boost_empty_content(self):
        ...
        doc1 = indexer.Doc(
            uri='url1', display_title='Documentation Guide', content='', index_title='Documentation Guide'
        )
        ...
        doc2 = indexer.Doc(
            uri='url2',
            display_title='Tutorial',
            content='This tutorial covers documentation development',
            index_title='Tutorial',
        )
    ...
    def test_title_boost_short_vs_long_content(self):
        ...
        short_content = 'Brief documentation overview.'
        doc1 = indexer.Doc(
            uri='url1', display_title='Documentation', content=short_content, index_title='Documentation Guide'
        )

        # Long content document
        long_content = 'This is a very detailed documentation development guide. ' * 50
        doc2 = indexer.Doc(
            uri='url2',
            display_title='Tutorial',
            content=long_content,
            index_title='Documentation Tutorial',
        )
