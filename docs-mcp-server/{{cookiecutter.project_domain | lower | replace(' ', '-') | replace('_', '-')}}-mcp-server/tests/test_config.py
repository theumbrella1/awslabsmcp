...
from awslabs.{{cookiecutter.project_domain | lower | replace(' ', '_') | replace('-', '_')}}_mcp_server.config import Config, doc_config
...
class TestConfig:
    ...
    def test_config_custom_values(self):
        ...
        # Arrange
        custom_urls = [
            'https://example.com/docs/doc1',
            'https://example.com/docs/doc2',
        ]
        custom_timeout = 60.0
    ...
    def test_config_supports_multiple_llm_urls(self):
        ...
        # Arrange
        multiple_urls = [
            '{{cookiecutter.allowed_domains.split(",")[0].strip()}}/docs/doc1',
            '{{cookiecutter.allowed_domains.split(",")[0].strip()}}/docs/doc2',
            '{{cookiecutter.allowed_domains.split(",")[0].strip()}}/docs/doc3',
        ]
