...
from awslabs.{{cookiecutter.project_domain | lower | replace(' ', '_') | replace('-', '_')}}_mcp_server.utils import doc_fetcher, text_processor
...
class TestTextProcessor:
    ...
    def test_title_from_url_extracts_slug(self):
        ...
        assert (
            text_processor.title_from_url('https://example.com/documentation_core_overview')
            == 'Documentation Core Overview'
        )
    ...
    def test_index_title_variants_generates_variants(self):
        ...
        display_title = 'Documentation Overview'
        url = 'https://example.com/documentation-core-overview'
    ...
    def test_normalize_for_comparison_removes_punctuation(self):
        ...
        assert (
            text_processor.normalize_for_comparison('Documentation-Overview') == 'documentation overview'
        )
